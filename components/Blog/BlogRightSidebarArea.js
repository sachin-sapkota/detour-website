                ...
                <div className='col-lg-6 col-md-6'>
                  <div className='blog-card style1'>
                    ...
                    <div className='blog-info'>
                      ...
                      <h3 className='blog-title'>
                        <Link href='/blog-details-right-sidebar'>
                          <a>5 Days In A Quiet Place Near Silicon</a>
                        </Link>
                      </h3>
                      <p>
                        Lorem ipsum dolor sit amet, consetetur sadipscing elitr,
                ...
                <div className='col-lg-6 col-md-6'>
                  <div className='blog-card style1'>
                    ...
                    <div className='blog-info'>
                      ...
                      <h3 className='blog-title'>
                        <Link href='/blog-details-right-sidebar'>
                          <a>10 Tips To Book Best Hotel For You</a>
                        </Link>
                      </h3>
                      <p>
                        Lorem ipsum dolor sit amet, consetetur sadipscing elitr,
                  ...
                  <div className='popular-post-widget'>
                    ...
                    <div className='pp-post-item'>
                      ...
                      <div className='pp-post-info'>
                        ...
                        <h6>
                          <Link href='/blog-details-right-sidebar'>
                            <a>How To Pack For The Camino De Santiago</a>
                          </Link>
                        </h6>
                      </div>
                    </div>
                    <div className='pp-post-item'>
                      ...
                      <div className='pp-post-info'>
                        ...
                        <h6>
                          <Link href='/blog-details-right-sidebar'>
                            <a>Best Street Food Around the World</a>
                          </Link>
                        </h6>
                      </div>
                    </div>
